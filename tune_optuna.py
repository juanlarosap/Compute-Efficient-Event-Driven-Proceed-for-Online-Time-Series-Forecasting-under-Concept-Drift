...
#STUDY_NAME_PREFIX = "proceed_combo_ETTh2"
STUDY_NAME_PREFIX = "proceed_combo_Weather"

STUDY_NAME_STAGE1 = f"{STUDY_NAME_PREFIX}_stage1"
STUDY_NAME_STAGE2 = f"{STUDY_NAME_PREFIX}_stage2"

CSV_PATH_STAGE1 = "optuna_trials_combo_Weather_stage1.csv"
CSV_PATH_STAGE2 = "optuna_trials_combo_Weather_stage2.csv"
LOG_DIR_STAGE1 = "optuna_logs_combo_Weather_stage1"
LOG_DIR_STAGE2 = "optuna_logs_combo_Weather_stage2"
...
#código para etth2
#MSE_BASE = 5.798308230637417
#MSE_MAX  = MSE_BASE * 1.01
#TIME_BASE = 96.99

#código para weather
MSE_BASE = 2.1821446334245977
MSE_MAX = MSE_BASE * 1.01
TIME_BASE = 1735.94
