...
need_x_mark = ['TCN', 'FSNet', 'OneNet', 'iTransformer', 'LSTM', 'LSTM_MLP']
...
hyperparams = {
    ...
    'LSTM': {'e_layers': 2, 'd_model': 128, 'dropout': 0.1, 'train_epochs': 10},
}

hyperparams['LSTM_MLP'] = {
    'e_layers': 2,
    'd_model': 128,
    'dropout': 0.1,
    'mlp_hidden': 128,
...
pretrain_lr_online_dict['LSTM_MLP'] = {
    'ETTh2': 0.0001, 'ETTm1': 0.0001, 'Traffic': 0.001, 'Weather': 0.0001, 'ECL': 0.0005
}
pretrain_lr_dict['LSTM_MLP'] = {
    'ETTh2': 0.0001, 'ETTm1': 0.0001, 'Traffic': 0.001, 'Weather': 0.0001, 'ECL': 0.0005
}
